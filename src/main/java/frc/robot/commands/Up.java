...
public class Up extends Command {
    ...
    public Up(RobotContainer robotContainer, RobotState robotTargetState, Elevator elevator, Wrist wrist) {
        this.robotContainer = robotContainer;
        m_elevator = elevator;
        m_wrist = wrist;
        targetElevatorPos = Constants.ElevatorConstants.pos[robotTargetState.ordinal()];
        targetWristPos = Constants.WristConstants.pos[robotTargetState.ordinal()];
